const DefaultConfig = {
    ...
    waveRiseTime: 1300, // The amount of time in milliseconds for the wave to rise from 0 to it's final height.
    ...
    textVertPosition: 0.7, // The height at which to display the percentage text withing the wave circle. 0 = bottom, 1 = top.
    ...
    textColor: "#9491a4", // The color of the value text when the wave does not overlap it.
